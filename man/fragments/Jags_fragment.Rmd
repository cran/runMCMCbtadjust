...
`r if (as.double(compar_MCMC_times[2,1])>as.double(compar_MCMC_times[2,2])) { "In line with this, the MCMC time per effective value remained lower with \"JAGS\" than with \"NIMBLE\" with this model (cf. table above)."}`
